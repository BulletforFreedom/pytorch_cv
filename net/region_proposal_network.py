...
def _enumerate_shifted_anchor(anchor_base, feat_stride, height, width):
    ...
    #shift the anchors to match the input image
    #Each anchor matches 9 anchor boxes, there are 32 anchors(input size:512, strides:16)
    #Each anchor matches 16*16 pixels
    #
