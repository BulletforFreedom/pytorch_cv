...
if __name__ == '__main__':
    '''
    a = transform(is_gt=True, src_file='/home/lsk/Downloads/test_img/Annotation',
                  images_file='/home/lsk/Downloads/test_img/JPEGImages', tar_file='/home/lsk/Downloads/test_img/ImageSets/new.json', mode='voc_to_coco')
    '''
    a = transform(is_gt=False, 
                  src_file='/home/lsk/Downloads/eval_yolo_detection/results/predict/missfresh-yolo-voc-800-0724/10000/voc',
                  images_file='/home/lsk/Downloads/test_img/JPEGImages', 
                  tar_file='/home/lsk/Downloads/eval_yolo_detection/results/predict/missfresh-yolo-voc-800-0724/10000/new.json', 
                  src_gt='/home/lsk/Downloads/test_img/ImageSets/gt.json',
                  mode='voc_to_coco')
    #src_gt='test/gt_coco_annotations/1.json',
    # Mode list: 'txt_to_voc','txt_to_coco','voc_to_coco','voc_to_csv'
