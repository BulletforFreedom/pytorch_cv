...
# -*- coding: utf-8 -*-
"""
Created on Thu Dec 13 16:53:07 2018
...
if __name__ == "__main__":    
    img = cv2.imread('/home/lsk/Downloads/pytorch_cv/project/segmentation/ADE_train_00000610.jpg')
    trimap = cv2.imread('/home/lsk/Downloads/pytorch_cv/project/segmentation/ADE_train_00000610_seg_smoothed.png')
    
    alpha = matting(img, trimap[:,:,0])
    show(alpha)
    rows, cols, channel = img.shape

    src = cv2.imread('/home/lsk/Downloads/pytorch_cv/project/segmentation/ADE_train_00000610.jpg', cv2.IMREAD_UNCHANGED)
    b, g, r = cv2.split(src)
    ...
    cv2.imwrite("/home/lsk/Downloads/pytorch_cv/project/segmentation/output.png", src)
    cv2.waitKey(0)